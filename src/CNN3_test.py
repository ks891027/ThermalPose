...
class SimpleCNN(pl.LightningModule):
    def __init__(self, num_classes=4, learning_rate=0.0001):
        ...
        self.fc1 = nn.Linear(128 * 32 * 32, 1024)  # 假設特徵圖的尺寸為 32x32
...
cnn_model = SimpleCNN.load_from_checkpoint("/home/yang/Documents/Thermal_Pose/ThermalPose/results/CNN3/best_model.ckpt")
...
output_path = '/home/yang/Documents/Thermal_Pose/ThermalPose/data/test_data/outputs'
