...
#%%
logger = TensorBoardLogger("tb_logs", name="resnet50_model")
trainer = pl.Trainer(
    max_epochs=20,
...
# 保存最好的模型
trainer.save_checkpoint("/home/yang/Documents/Thermal_Pose/ThermalPose/results/ResNet50/best_model.ckpt")
